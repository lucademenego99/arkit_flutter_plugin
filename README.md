...
Then clear the SwiftPM manifest cache and DerivedData so Xcode re-evaluates the package manifest with the new value:
```sh
...
export ARKIT_FACE_TRACKING_ENABLED=1
